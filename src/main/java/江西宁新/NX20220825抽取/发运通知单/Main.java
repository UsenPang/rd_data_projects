...
public class Main {
    static String[] headKey = {"文件路径信息","文件名称","凭证号","页码","订单号","发运日期","签收日期"};


    public static void main(String[] args) {
        String preffix = "发运通知单-";
//        String tablePath = "C:\\Users\\荣大\\Desktop\\NX20220829采购抽取\\凭证号整理完整版";
        String tablePath = "C:\\Users\\荣大\\Desktop\\NX20220829采购抽取\\宁和达";

        String excelOut = "E:\\江西宁新\\宁新抽取\\宁新销售抽取\\发运通知单";
