...
import 江西宁新.NX20220829采购抽取.executor.SimpleExecutor;
...
public class Main {
    private static String[] headKey = {"文件名称","文件路径信息","凭证号","页码","付款合同号","付款金额","付款日期","付款金额大写"};
    public static void main(String[] args) {
        String tablePath = "C:\\Users\\荣大\\Desktop\\NX20220829采购抽取\\凭证号整理完整版";
        String excelOut = "E:\\江西宁新\\宁新抽取\\宁新采购抽取\\付款申请单";
        ...
        for (int i = 0; i < tables.length; i++) {
            ...
            ExcelReader reader1 = ExcelUtil.getReader(new File(excelInput), "采购记账凭证");
            ExcelReader reader2 = ExcelUtil.getReader(new File(excelInput), "采购付款凭证");
